export default function Attribute({ name, correct, image, bgSize, opacity, character}) {
    return (
        <div className="w-20 h-20 shadow-md flex-shrink-0 rounded-lg overflow-hidden text-balance">
            <a className={`
            ...
            >
                ...
                <span 
                    className={`${bgSize ? bgSize : "bg-cover bg-center"} absolute inset-0 bg-no-repeat ${opacity ? opacity : ""}`}
